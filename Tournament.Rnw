...
for (i in (1:N)) {
  ...
  for (j in (1:n)) {
    ifelse(Aldous==TRUE, 
           tour_run$q[j] <- sample(c(tour_run$lower.limit[j], tour_run$upper.limit[j]),1) ,
...
for (i in (1:N)) {
  for (j in (1:n)) {
    ...
    ifelse(Aldous==TRUE, 
           tour_run$q1[j] <- sample(c(tour_run$lower.limitC1[j], tour_run$upper.limitC1[j]),1) ,
    ...
    ifelse(Aldous==TRUE, 
           tour_run$q2[j] <- sample(c(tour_run$lower.limitC2[j], tour_run$upper.limitC2[j]),1) ,
